  ...
  return (
    <div className="space-y-4 sm:space-y-5">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <Label className="text-white/90 font-medium">Pin the location</Label>
        <span className="w-fit text-xs text-gray-400 bg-white/5 px-2 py-1 rounded-full border border-white/5">
          Click map to place marker
        </span>
      </div>

      <div className="h-[320px] sm:h-[420px] lg:h-[520px] w-full rounded-xl overflow-hidden border border-white/10 shadow-2xl relative group">
