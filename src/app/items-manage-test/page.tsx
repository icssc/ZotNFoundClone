      ...
      <div className="text-white h-full w-full flex justify-center">
        <div className="flex gap-2 h-full flex-col">
          <form className="flex flex-col" onSubmit={(e) => {
            ...
            const itemId = parseInt((form.elements.namedItem("itemId") as HTMLInputElement).value);
            const isHelped = (form.elements.namedItem("isHelped") as HTMLInputElement).checked;
            const isResolved = (form.elements.namedItem("isResolved") as HTMLInputElement).checked;
